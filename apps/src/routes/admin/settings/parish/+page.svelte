<script lang="ts">
	...
	import { Alert, Badge, Breadcrumb, BreadcrumbItem, Button, Dropdown, DropdownItem, Input, Label, Modal, Table, TableBody, TableBodyCell, TableBodyRow, TableHead, TableHeadCell } from 'flowbite-svelte';
